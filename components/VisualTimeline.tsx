...
const VisualTimeline: React.FC<VisualTimelineProps> = ({ onClose }) => {
  const events = [
    { date: '11 Dec - 29 Feb', title: 'Phase 1: Foundation', desc: 'DSA (Python) + MERN Stack', icon: Flag, color: 'bg-blue-500' },
    { date: '25-29 Feb', title: 'Phase 1 Exams', desc: 'DSA, Web Dev, Life Skills', icon: Star, color: 'bg-blue-600' },
    { date: '1 Mar - 31 May', title: 'Phase 2: Development', desc: 'App Dev + Advanced DSA', icon: Target, color: 'bg-indigo-500' },
    { date: '25-31 May', title: 'Phase 2 Exams', desc: 'App Dev, Adv DSA, Comm Skills', icon: Star, color: 'bg-indigo-600' },
    { date: '1 Jun - 30 Aug', title: 'Phase 3: Modern Skills', desc: 'Agentic AI + Soft Skills', icon: Target, color: 'bg-purple-500' },
    { date: '25-31 Aug', title: 'Phase 3 Exams', desc: 'AI, Soft Skills, Time & Finance', icon: Star, color: 'bg-purple-600' },
    { date: '1 Sep - 30 Nov', title: 'Phase 4: Mastery', desc: 'Must-Have Skills (Brand/Product)', icon: Target, color: 'bg-pink-500' },
    { date: '25-30 Nov', title: 'Phase 4 Exams', desc: 'Personal Brand, Product Mgmt', icon: Star, color: 'bg-pink-600' },
    { date: '7-9 Dec', title: 'THE FINAL EXAMS', desc: 'Grand Technical & Life Skills Exam', icon: Trophy, color: 'bg-yellow-500' },
    { date: '11 Dec - 28 Feb', title: 'Phase 5: Execution', desc: 'Projects, Job Hunt, Launch', icon: Flag, color: 'bg-emerald-500' },
  ];
