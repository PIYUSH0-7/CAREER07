...
import { CheckCircle2, Award, Calendar, ChevronDown, ChevronRight, Play, BookOpen, Brain, Activity, Heart, Clock, Users, Zap, Target, FileText, ExternalLink, Compass } from 'lucide-react';
  ...
  const phases = [
    {
      ...
      examSchedule: [
        { date: "25 Feb", event: "DSA with Python" },
        { date: "27 Feb", event: "Full Stack Web Development" },
        { date: "28 Feb", event: "Learning + Health Management" },
        { date: "29 Feb", event: "Phase 1 Result Analysis" }
      ]
    },
    {
      id: 2,
      ...
      examSchedule: [
        { date: "25 May", event: "App Development" },
        { date: "27 May", event: "Advanced DSA" },
        { date: "28 May", event: "Thinking + Communication" },
        { date: "31 May", event: "Phase 2 Result Analysis" }
      ]
    },
    {
      id: 3,
      title: "PHASE 3 — Modern Skills",
      date: "1 June – 30 August",
      ...
      skills: [
        { 
          ...
          domainId: "agentic-ai", 
          icon: Brain,
          link: "https://drive.google.com/file/d/1OTpeU-QqJBJmzGcFxW6cP90ZD4mPRcbi/view?usp=drive_link"
        },
        { 
          name: "Soft Skills", 
      ...
      examSchedule: [
        { date: "25 Aug", event: "Agentic AI" },
        { date: "27 Aug", event: "Soft Skills Placement Test" },
        { date: "28 Aug", event: "Time + Finance Management" },
        { date: "31 Aug", event: "Phase 3 Result Analysis" }
      ]
    },
    {
      id: 4,
      ...
      examSchedule: [
        { date: "25-27 Nov", event: "Must-Have Skills Exams" },
        { date: "29 Nov", event: "All Previous Skills Exam" },
        { date: "30 Nov", event: "Phase 4 Result Analysis" }
      ]
    },
    {
      id: 5,
      title: "FINAL EXAMS & EXECUTION",
      date: "7 December – 28 February",
      ...
      examSchedule: [
        { date: "7 Dec", event: "GRAND TECHNICAL EXAM" },
        { date: "9 Dec", event: "LIFE SKILLS FINAL" },
        { date: "10 Dec", event: "Career Prediction Analysis" },
        { date: "11 Dec+", event: "Real-World Execution" }
      ]
    }
  ];
              ...
              {activePhase === phase.id && (
                <div className="p-6 bg-gray-50/50 border-t border-gray-100 animate-in slide-in-from-top-2 duration-200">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {/* Skills Grid */}
                    <div>
                      <h4 className="font-bold text-gray-900 mb-4 text-xs uppercase tracking-widest text-indigo-600">Skills to Learn</h4>
